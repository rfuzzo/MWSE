...
--- @field mobile tes3mobileCreature|tes3mobileNPC|tes3mobileObject|tes3mobilePlayer|tes3mobileProjectile|tes3mobileSpellProjectile *Read-only*. Mobile object which collided with its target reference.
