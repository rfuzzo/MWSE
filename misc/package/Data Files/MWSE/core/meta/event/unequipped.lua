...
--- @field actor tes3actor|tes3container|tes3containerInstance|tes3creature|tes3creatureInstance|tes3npc|tes3npcInstance *Read-only*. The actor that has unequipped the item.
...
--- @field reference tes3reference *Read-only*. actor’s associated reference.
