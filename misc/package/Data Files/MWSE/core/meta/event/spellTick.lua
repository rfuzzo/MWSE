...
--- @field effect tes3effect *Read-only*. The individual effect structure on source.
--- @field effectId tes3.effect|integer *Read-only*. The magic effect ID that is being ticked. Maps to values in [`tes3.effect`](https://mwse.github.io/MWSE/references/magic-effects/) namespace.
--- @field effectIndex integer *Read-only*. The index of the effect in source’s effects list.
