...
--- @param params Logger.new.params? This table accepts the following values:
--- 
...
function Logger.new(params) end

---Table parameter definitions for `Logger.new`.
...
function Logger:assert(condition, message, ...) end
...
--- 	
---
--- [Examples available in online documentation](https://mwse.github.io/MWSE/types/Logger/#debug).
...
function Logger:doLog(logLevel) end
...
function Logger:setLogLevel(newLogLevel) end

--- Set the output file. If set, logs will be sent to a file of this name.
--- @param outputFile string No description yet available.
function Logger:setOutputFile(outputFile) end

--- Log trace message.
--- @param message string No description yet available.
--- @param ... any? *Optional*. Formatting arguments. These are passed to `string.format`.
function Logger:trace(message, ...) end
