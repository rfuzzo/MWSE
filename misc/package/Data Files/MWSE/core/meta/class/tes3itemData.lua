...
--- 
--- For more info see the description of [tes3itemStack](https://mwse.github.io/MWSE/types/tes3itemStack/).
--- @class tes3itemData
...
--- @field count number The total number of identical items represented by this data. Reserved for use by in-world references. It should always be `1` for items in inventories. Inventories utilize the stack count in [`tes3itemStack`](https://mwse.github.io/MWSE/types/tes3itemStack/) object.
...
--- @field owner tes3npc|tes3faction|nil The owner of the associated item. An item can have an owner or it can be faction-owned.
...
--- @field soul tes3actor|tes3container|tes3containerInstance|tes3creature|tes3creatureInstance|tes3npc|tes3npcInstance Only available on misc items. The actor that is stored inside the soul gem.
