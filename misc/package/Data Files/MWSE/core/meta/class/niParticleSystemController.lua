...
--- @field emitterModifiers niKeyframeController[]|niKeyframeManager[]|niLookAtController[]|niParticleSystemController[]|niPathController[] Modifiers that will influence the particle system by modifying the emitting object.
