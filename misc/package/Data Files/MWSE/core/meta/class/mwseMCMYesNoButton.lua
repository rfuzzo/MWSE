...
--- @class mwseMCMYesNoButton : mwseMCMButton, mwseMCMSetting, mwseMCMComponent
...
--- @param data mwseMCMYesNoButton.new.data? This table accepts the following values:
--- 
...
function mwseMCMYesNoButton:new(data) end

---Table parameter definitions for `mwseMCMYesNoButton.new`.
--- @class mwseMCMYesNoButton.new.data
...
function mwseMCMYesNoButton:press() end
