...
--- @field bloodMeshes niBSAnimationNode[]|niBSParticleNode[]|niBillboardNode[]|niCollisionSwitch[]|niNode[]|niSortAdjustNode[]|niSwitchNode[] *Read-only*. A list of loaded blood meshes.
