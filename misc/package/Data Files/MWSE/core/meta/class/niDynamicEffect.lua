...
--- @param node niBillboardNode|niCollisionSwitch|niNode|niSortAdjustNode|niSwitchNode The node to add to the affected nodes list.
...
--- @param node niBillboardNode|niCollisionSwitch|niNode|niSortAdjustNode|niSwitchNode The node to remove from the affected nodes list.
