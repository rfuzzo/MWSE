...
--- @field pointerMoveEventSource tes3uiElement *Read-only*. No description yet available.
--- @field pointerMovePreviousEventSource tes3uiElement *Read-only*. No description yet available.
--- @field textInputFocus tes3uiElement|nil The element that is currently focused for text input.
