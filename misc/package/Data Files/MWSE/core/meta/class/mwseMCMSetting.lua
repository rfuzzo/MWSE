...
--- @return mwseMCMActiveInfo|mwseMCMButton|mwseMCMDecimalSlider|mwseMCMDropdown|mwseMCMHyperlink|mwseMCMInfo|mwseMCMMouseOverInfo|mwseMCMOnOffButton|mwseMCMParagraphField|mwseMCMSetting|mwseMCMSlider|mwseMCMTextField|mwseMCMYesNoButton setting No description yet available.
