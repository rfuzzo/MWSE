...
--- @field force number The magnitude of the gravitational force in [units/second](https://mwse.github.io/MWSE/references/general/game-units/).
--- @field forceType ni.gravityForceType The type of the modifier. Planar force will attract the particles parallel to the `.direction` vector. Spherical force will act so that the point defined by `.position` property is the source of the spherical gravitational force.
--- 
