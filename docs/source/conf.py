...
project = 'Morrowind Script Extender'
...
htmlhelp_basename = 'MorrowindScriptExtenderv2doc'
...
latex_documents = [
    (master_doc, 'MorrowindScriptExtenderv2.tex', 'Morrowind Script Extender v2 Documentation',
     'MWSE Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'morrowindscriptextenderv2', 'Morrowind Script Extender v2 Documentation',
     [author], 1)
]
