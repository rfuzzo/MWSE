# niSortAdjustNode
<div class="search_terms" style="display: none">nisortadjustnode, sortadjustnode</div>
...
### `accumulator`
<div class="search_terms" style="display: none">accumulator</div>

An optional accumulator used by the mode ni.sortAdjustMode.subsort.

**Returns**:

* `result` (niAccumulator, nil)
...
### `sortingMode`
<div class="search_terms" style="display: none">sortingmode</div>

The sorting mode for the subtree. There is an additional group sorting mode added by MWSE. Maps to values in the [`ni.sortAdjustMode`](https://mwse.github.io/MWSE/references/ni/sort-adjust-modes/) table.

**Returns**:

* `result` ([ni.sortAdjustMode](../references/ni/sort-adjust-modes.md))
