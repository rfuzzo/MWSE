...
This type inherits the following: [niParticles](../../types/niParticles), [niTriBasedGeometry](../../types/niTriBasedGeometry), [niGeometry](../../types/niGeometry), [niAVObject](../../types/niAVObject), [niObjectNET](../../types/niObjectNET), [niObject](../../types/niObject)
## Properties
...
The niRotatingParticlesData of the object. Manipulation should not be done directly. Instead, consider copying the data and assigning it to this shape.

**Returns**:

* `result` ([niRotatingParticlesData](../../types/niRotatingParticlesData))
