...
<div class="search_terms" style="display: none">mwsemcmmouseoverpage</div>
...
* `result` ([mwseMCMMouseOverPageElements](../types/mwseMCMMouseOverPageElements.md))
...
<div class="search_terms" style="display: none">createmouseoverblock, mouseoverblock</div>
