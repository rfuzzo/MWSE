# niBSAnimationNode
<div class="search_terms" style="display: none">nibsanimationnode, bsanimationnode</div>
...
```lua
local node = niBSAnimationNode.new()
```

**Returns**:

* `node` ([niBSAnimationNode](../types/niBSAnimationNode.md))
