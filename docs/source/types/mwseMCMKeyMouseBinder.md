...
<div class="search_terms" style="display: none">mwsemcmkeymousebinder</div>
...
The name for this keybind. This name is shown in the popup menu.
...
```lua
local button = myObject:new({ label = ..., description = ..., keybindName = ..., leftSide  = ..., variable = ..., defaultSetting = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ..., class = ..., componentType = ..., parentComponent = ... })
```
