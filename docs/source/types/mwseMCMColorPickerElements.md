...
<div class="search_terms" style="display: none">mwsemcmcolorpickerelements</div>
...
### `picker`
<div class="search_terms" style="display: none">picker</div>

The UI element that contains the color picker widget.
