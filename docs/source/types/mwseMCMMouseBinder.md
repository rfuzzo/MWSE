# mwseMCMMouseBinder
<div class="search_terms" style="display: none">mwsemcmmousebinder</div>
...
### `allowButtons`
<div class="search_terms" style="display: none">allowbuttons</div>
...
### `allowWheel`
<div class="search_terms" style="display: none">allowwheel</div>
...
* `data` (table): *Optional*.
	...
	* `variable` ([mwseMCMVariable](../types/mwseMCMVariable.md), [mwseMCMSettingNewVariable](../types/mwseMCMSettingNewVariable.md)): *Optional*. A variable for this MouseBinder.
