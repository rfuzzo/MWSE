# niSpotLight
<div class="search_terms" style="display: none">nispotlight, spotlight</div>
...
### `spotAngle`
<div class="search_terms" style="display: none">spotangle</div>
...
### `spotExponent`
<div class="search_terms" style="display: none">spotexponent</div>
...
* `result` ([ni.dynamicEffectType](../references/ni/dynamic-effect-types.md))
