...
* `result` ([niTriShapeData](../types/niTriShapeData.md))
...
### `skinInstance`
<div class="search_terms" style="display: none">skininstance</div>

The skinInstance of the object.

**Returns**:

* `result` ([niSkinInstance](../types/niSkinInstance.md))
...
* `shape` ([niTriShape](../types/niTriShape.md))
