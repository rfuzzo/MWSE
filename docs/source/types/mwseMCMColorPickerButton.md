...
<div class="search_terms" style="display: none">mwsemcmcolorpickerbutton</div>
...
This type inherits the following: [mwseMCMColorPicker](../types/mwseMCMColorPicker.md), [mwseMCMSetting](../types/mwseMCMSetting.md), [mwseMCMComponent](../types/mwseMCMComponent.md).
## Properties

### `alpha`
<div class="search_terms" style="display: none">alpha</div>

If `true` the picker also allows picking an alpha value.
...
This dictionary holds all the UI elements of the color picker button, for easy access.

**Returns**:

* `result` ([mwseMCMColorPickerButtonElements](../types/mwseMCMColorPickerButtonElements.md))
...
### `vertical`
<div class="search_terms" style="display: none">vertical</div>

If `true`, saturation, hue and alpha bars and color previews are created in the second row below the main picker. If `false` they are created in the same row as the main picker.
...
```lua
local pickerButton = myObject:new({ label = ..., description = ..., alpha = ..., variable = ..., defaultSetting = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ..., class = ..., componentType = ..., parentComponent = ... })
```
...
* `data` (table): *Optional*.
	...
	* `variable` ([mwseMCMVariable](../types/mwseMCMVariable.md), [mwseMCMSettingNewVariable](../types/mwseMCMSettingNewVariable.md)): *Optional*. A variable for this Color picker button.
	* `defaultSetting` ([mwseColorTable](../types/mwseColorTable.md), [mwseColorATable](../types/mwseColorATable.md)): *Optional*. If `defaultSetting` wasn't passed in the `variable` table, can be passed here. The new variable will be initialized to this value.
