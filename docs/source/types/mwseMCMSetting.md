# mwseMCMSetting
<div class="search_terms" style="display: none">mwsemcmsetting</div>
...
* `data` (table): *Optional*.
	...
	* `postCreate` (fun(self: [mwseMCMSetting](../types/mwseMCMSetting.md))): *Optional*. Can define a custom formatting function to make adjustments to any element saved in `self.elements`.
...
* `setting` ([mwseMCMSetting](../types/mwseMCMSetting.md))
