...
### `testFunction`
<div class="search_terms" style="display: none">testfunction, function</div>
...
* `result` ([ni.zBufferPropertyTestFunction](../references/ni/z-buffer-property-test-functions.md))
...
* `property` ([niZBufferProperty](../types/niZBufferProperty.md))
