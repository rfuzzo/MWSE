...
<div class="search_terms" style="display: none">niautonormalparticles, autonormalparticles</div>
...
* `result` ([niParticlesData](../types/niParticlesData.md))
...
```lua
local particles = niAutoNormalParticles.new(vertexCount, hasColors)
```
...
* `particles` ([niAutoNormalParticles](../types/niAutoNormalParticles.md))
