# mwseMCMColorPicker
<div class="search_terms" style="display: none">mwsemcmcolorpicker</div>
...
This dictionary holds all the UI elements of the color picker, for easy access.

**Returns**:

* `result` ([mwseMCMColorPickerElements](../types/mwseMCMColorPickerElements.md))
...
```lua
local picker = myObject:new({ label = ..., description = ..., alpha = ..., vertical = ..., variable = ..., defaultSetting = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ..., class = ..., componentType = ..., parentComponent = ... })
```
...
* `data` (table): *Optional*.
	...
	* `variable` ([mwseMCMVariable](../types/mwseMCMVariable.md), [mwseMCMSettingNewVariable](../types/mwseMCMSettingNewVariable.md)): *Optional*. A variable for this Color picker.
