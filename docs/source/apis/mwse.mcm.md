...
```lua
local button = mwse.mcm.createKeyBinder(parent, { label = ..., description = ..., allowCombinations  = ..., leftSide  = ..., variable = ..., defaultSetting = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ... })
```
...
```lua
local paragraphField = mwse.mcm.createParagraphField(parent, { label = ..., buttonText = ..., variable = ..., description = ..., height = ..., sNewValue = ..., sNumbersOnly = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ... })
```
...
```lua
local textField = mwse.mcm.createTextField(parent, { label = ..., buttonText = ..., variable = ..., description = ..., press = ..., sNewValue = ..., sNumbersOnly = ..., minHeight = ..., callback = ..., inGameOnly = ..., restartRequired = ..., restartRequiredMessage = ..., indent = ..., childIndent = ..., paddingBottom = ..., childSpacing = ..., postCreate = ... })
```
