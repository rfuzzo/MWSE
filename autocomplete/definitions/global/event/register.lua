	...
	arguments = {
		...
		{ name = "callback", type = "function" },
		{
			...
			tableParams = {
				...
				{ name = "filter", type = "userdata|string|number|tes3baseObject", optional = true, description = "This parameter allows selectively executing the callback function only when a specific condition is met. The exact behavior depends on each event." }, --try other types: "userdata|any"...
