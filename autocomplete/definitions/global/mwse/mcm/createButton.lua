return {
	type = "function",
	description = [[Creates a new Button inside given `parent` menu.
...
The same is done by this function if you pass both `parent` and `data` arguments.
	...
	arguments = {
		{ name = "parent", type = "tes3uiElement|mwse.mcm.createButton.data", description = "The UI element inside which the new Button will be created." },
		{
			name = "data",
			type = "table",
			optional = true,
