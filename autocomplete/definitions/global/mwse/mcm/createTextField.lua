return {
	type = "function",
	description = [[Creates a new TextField inside given `parent` menu.
...
The same is done by this function if you pass both `parent` and `data` arguments.
	...
	arguments = {
		{ name = "parent", type = "tes3uiElement|mwse.mcm.createTextField.data", description = "The UI element inside which the new TextField will be created." },
		{
			name = "data",
			type = "table",
			optional = true,
