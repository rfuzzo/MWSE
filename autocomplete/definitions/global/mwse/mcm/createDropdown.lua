return {
	type = "function",
	description = [[Creates a new Dropdown inside given `parent` menu.
...
The same is done by this function if you pass both `parent` and `data` arguments.
	...
	arguments = {
		{ name = "parent", type = "tes3uiElement|mwse.mcm.createDropdown.data", description = "The UI element inside which the new Dropdown will be created." },
		{
			name = "data",
			type = "table",
			optional = true,
