return {
	type = "function",
	description = [[Creates a new MouseOverInfo inside given `parent` menu.
...
The same is done by this function if you pass both `parent` and `data` arguments.
	...
	arguments = {
		{ name = "parent", type = "tes3uiElement|mwse.mcm.createMouseOverInfo.data|string", description = "The UI element inside which the new MouseOverInfo will be created." },
		{
			name = "data",
			type = "table|string",
			optional = true,
