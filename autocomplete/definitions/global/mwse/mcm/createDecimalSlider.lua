...
The same is done by this function if you pass both `parent` and `data` arguments.
	...
	arguments = {
		{ name = "parent", type = "tes3uiElement|mwse.mcm.createDecimalSlider.data", description = "The UI element inside which the new DecimalSlider will be created." },
		{
			name = "data",
			type = "table",
			optional = true,
			tableParams = {
				...
				{ name = "variable", type = "mwseMCMVariable", description = "A variable for this setting." },
