return {
	...
	arguments = {
		{ name = "specializationId", type = "tes3.specialization", description = "Maps to [`tes3.specialization`](https://mwse.github.io/MWSE/references/specializations/) enumeration." }
	},
