...
You can read a list of already claimed magic effects [here](https://mwse.github.io/MWSE/references/magic-effects-modded/). New magic effect's `id` should be higher than 142 (the last vanilla magic effect), an not already claimed.]],
	arguments = {
