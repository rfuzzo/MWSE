return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "position", type = "tes3vector3|number[]", description = "The new coordinates of the transition." },
			{ name = "orientation", type = "tes3vector3|number[]", description = "The new rotation to use after transition." },
