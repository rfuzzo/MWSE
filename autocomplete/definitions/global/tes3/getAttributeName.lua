return {
	...
	arguments = {
		{ name = "attributeId", type = "tes3.attribute", description = "The attribute id to get the name of. Maps to values in [`tes3.attribute`](https://mwse.github.io/MWSE/references/attributes/) namespace." }
	},
