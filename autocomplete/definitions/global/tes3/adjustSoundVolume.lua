return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "mixChannel", type = "tes3.soundMix|integer", optional = true, default = "tes3.soundMix.effects", description = "The channel to base volume off of. Maps to [`tes3.soundMix`](https://mwse.github.io/MWSE/references/sound-mix-types/) constants." },
