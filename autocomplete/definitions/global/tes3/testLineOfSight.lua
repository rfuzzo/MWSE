...
The collision root node is used for testing, if present in the model.]],
	arguments = {{
		...
		tableParams = {
			...
			{ name = "position1", type = "tes3vector3|table", optional = true, description = "Position of the starting point of the LoS check. Modified by height1." },
			...
			{ name = "position2", type = "tes3vector3|table", optional = true, description = "Position of the ending point of the LoS check. Modified by height2." },
