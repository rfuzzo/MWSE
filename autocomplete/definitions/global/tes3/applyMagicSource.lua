		...
		tableParams = {
			...
			{ name = "name", type = "string", optional = true, description = "While optional for other uses, if applying alchemy as a source, you must specify a name for the magic source." },
			{
				...
				tableParams = {
					...
					{ name = "rangeType", type = "tes3.effectRange", optional = true, default = "tes3.effectRange.self", description = "The range of the effect. This maps to [`tes3.effectRange`](https://mwse.github.io/MWSE/references/effect-ranges/) constants." },
