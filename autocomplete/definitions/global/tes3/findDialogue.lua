...
For example, `tes3.findDialogue({type = tes3.dialogueType.greeting, page = tes3.dialoguePage.greeting.greeting0})` will return the "Greeting 0" topic, which is not available using a topic ID.]],
	arguments = {{
		...
		tableParams = {
			...
			{ name = "type", type = "tes3.dialogueType|integer", optional = true, description = "The type of dialogue to look for. Uses [`tes3.dialogueType`](https://mwse.github.io/MWSE/references/dialogue-types/) constants." },
			{ name = "page", type = "tes3.dialoguePage.voice|tes3.dialoguePage.greeting|tes3.dialoguePage.service|integer", optional = true, description = "The page of dialogue to fetch. Uses [`tes3.dialoguePage`](https://mwse.github.io/MWSE/references/dialogue-pages/) constants." },
		},
	}},
