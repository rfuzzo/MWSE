return {
	...
	arguments = {{
		...
		tableParams = {
			...
			{ name = "destination", type = "tes3vector3|number[]", optional = true },
			{ name = "duration", type = "integer", optional = true, default = 0, description = "How long the follower will follow, in hours." },
