return {
	...
	arguments = {
		...
		{ name = "triIndex", type = "tes3.animationBodySection", description = "The body section on which to play the animation. A value from [`tes3.animationBodySection`](https://mwse.github.io/MWSE/references/animation-body-sections/) namespace." },
