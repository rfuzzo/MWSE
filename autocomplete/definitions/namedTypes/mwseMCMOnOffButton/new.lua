return {
	type = "method",
	description = [[Creates a new OnOffButton.]],
	arguments = {{
		name = "data",
		type = "table",
		optional = true,
		tableParams = {
			...
			{ name = "variable", type = "mwseMCMVariable|mwseMCMSettingNewVariable", optional = true, description = "A variable of given class for this Button." },
