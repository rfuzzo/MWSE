return {
	type = "method",
	description = [[Creates a new KeyMouseBinder.]],
	arguments = {{
		name = "data",
		type = "table",
		optional = true,
		tableParams = {
			...
			{ name = "keybindName", type = "string", description = "The keybind name. Shown in the popup menu." },
			...
			{ name = "variable", type = "mwseMCMVariable|mwseMCMSettingNewVariable", optional = true, description = "A variable for this KeyMouseBinder." },
			...
			{ name = "callback", type = "fun(self: mwseMCMKeyMouseBinder)", optional = true, description = "The custom function called when the player interacts with this KeyMouseBinder." },
			...
			{ name = "postCreate", type = "fun(self: mwseMCMKeyMouseBinder)", optional = true, description = "Can define a custom formatting function to make adjustments to any element saved in `self.elements`." },
	...
	returns = {{
		name = "button", type = "mwseMCMKeyMouseBinder"
	}}
}
