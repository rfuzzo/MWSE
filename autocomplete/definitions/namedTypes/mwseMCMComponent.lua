return {
	type = "class",
	description = [[The base class for all MCM components, such as categories and settings. The basic component has a block UI element that holds a label. This is used to implement the following components:
