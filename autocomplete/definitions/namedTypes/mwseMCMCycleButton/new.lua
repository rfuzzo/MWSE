return {
	type = "method",
	description = [[Creates a new mwseMCMCycleButton.]],
	arguments = {{
		name = "data",
		type = "table",
		tableParams = {
			...
			{ name = "variable", type = "mwseMCMVariable|mwseMCMSettingNewVariable", optional = true, description = "A variable for this cycle button." },
