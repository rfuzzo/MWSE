return {
	...
	arguments = {
		{ name = "skillId", type = "tes3.skill", description = "The index of the skill statistic to fetch. Maps to values in [`tes3.skill`](https://mwse.github.io/MWSE/references/skills/) namespace." },
	},
