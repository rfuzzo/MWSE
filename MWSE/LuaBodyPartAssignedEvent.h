...
namespace mwse::lua::event {
	...
	public:
		BodyPartAssignedEvent(TES3::BodyPartManager* manager, TES3::Reference* reference, const TES3::PhysicalObject* object, TES3::BodyPartManager::ActiveBodyPart::Index index, TES3::BodyPart* bodyPart, bool isFirstPerson);
		sol::table createEventTable();

	protected:
		TES3::BodyPartManager* m_BodyPartManager;
		TES3::Reference* m_Reference;
		const TES3::PhysicalObject* m_Object;
