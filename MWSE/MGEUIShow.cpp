/************************************************************************
	...
	MGEUIShow.cpp - Copyright (c) 2008 The MWSE Project
...
namespace mwse
{
	class MGEUIShow : mwse::InstructionInterface_t
	{
	public:
		MGEUIShow();
	...
	static MGEUIShow MGEUIShowInstance;

	MGEUIShow::MGEUIShow() : mwse::InstructionInterface_t(OpCode::MGEUIShow) {}

	void MGEUIShow::loadParameters(mwse::VMExecuteInterface& virtualMachine) {}
	...
	float MGEUIShow::execute(mwse::VMExecuteInterface& virtualMachine)
	{
